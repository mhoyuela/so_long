...
SRCS = errors.c map_check.c map_things.c mov.c moves.c so_long.c textures.c utils.c utils2.c
...
NAME = so_long
INCLUDES = -I . -I ${LIBFT_DIR} -I ${GNL_DIR} -I ${PRINTF_DIR} -I ${MLX_DIR}/include
...
$(NAME): $(OBJS)
	...
	@$(CC) $(INCLUDES) $(OBJS) -L$(LIBFT_DIR) -lft -L$(PRINTF_DIR) -lftprintf $(MLX_FLAGS) -o $(NAME)
